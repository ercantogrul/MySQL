...
where maas>20000
union -- iki tablo arasinda farkli olanlari getiriyor.
select sehir from personel
where maas>10000;

select isim as isim_sehir from personel 
where maas>20000
union all -- iki tablonun tamamini getiriyor.
select sehir from personel
where maas>10000;
...
-- ikinci yol ve daha kolay in ile 
...
------------------------------------------------------------------------------*/
select sehir as sehir_tel, maas as maas_cocuk from personel 
where id=123456733
union
