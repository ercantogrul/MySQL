...
/*=============================== INNER JOIN  ==================================
    ...
    FROM tablo1 
    INNER JOIN tablo2    -- inner default dur yazilmasada olur
...
select sirket.sirket_id,sirket_isim,siparis_id,siparis_tarihi
from sirket
join siparis -- default olarak inner join oldugu icin inner yazmak zorunda degiliz
on sirket.sirket_id=siparis.sirket_id;
...
------------------------------------------------------------------------------*/ 
select sirket.*, siparis_id,siparis_tarihi
from sirket
left join siparis
on sirket.sirket_id = siparis.sirket_id;
...
select siparis.*, sirket.sirket_isim
from sirket
right join siparis
on sirket.sirket_id = siparis.sirket_id;
...
select siparis_id,siparis_tarihi, siparis.sirket_id, sirket.sirket_isim
from sirket
right join siparis  -- esas tablo
on sirket.sirket_id=siparis.sirket_id
union
select siparis_id,siparis_tarihi, sirket.sirket_id,  sirket.sirket_isim
from sirket  -- esas tablo
left join siparis
on sirket.sirket_id=siparis.sirket_id;

-- kesisim kümesi verilerini nereden aliyorsak "ana tablo" odur
-- left join varsa ana tablo--from ..... dir
-- right join varsa ana tablo--right join ...... dir
