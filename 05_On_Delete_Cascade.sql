...
(
id CHAR(3) primary key,  -- primary key varsa Parent table dir.
isim VARCHAR(50),
...
select * from notlar;
delete from ogrenciler where id=104; -- parent table record FK' den sonra on delete cascade oldugu icin parent ve child  tabledeki veriler silindi.
select * from ogrenciler;

-- drop bütün tabloyu siler
-- delet tablonun icerisini siler
-- truncate-drop
